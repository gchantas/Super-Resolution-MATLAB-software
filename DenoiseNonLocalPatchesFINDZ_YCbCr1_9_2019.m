...
ssigma=(10/255)^2;%10^(PSNR/10)/255;

g=f(1:Nx,1:Ny)  +   sqrt(ssigma)*randn(Nx,Ny);
...
[alpha, ssigma, x]= stat_rest(alpha,ssigma,g,Q,ones(Nx,Ny),Nx,Ny);
...
clear E;
     ...
     % x=g2(1:Nx,1:Ny);
       ...
       ssigma=ssigma/14;%10^(-4)/255;%log(alpha+1);
