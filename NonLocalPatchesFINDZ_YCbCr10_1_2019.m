%function [PSNR, ISNR, SSIMres]=NonLocalPatchesFINDZ_YCbCr10_1_2019(pathHR,pathLR,imNumber)
...
for j1=1:1:250
    ...
    if  fcorr(k1(indx),l1(indx))<fcorrMax*0.20
     break;
    end
...
% %  
% %     
  [loglikelihood,nu,c2]=trainPCMixtureOneLMAPz(expNum,c2,nu,E,S);
%  
