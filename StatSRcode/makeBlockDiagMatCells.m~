...
if decFac==1
    ...
    BlockDiagMatCells{1,1}  =   makeBlockDiagMatCells(Nx,  Ny,  decFac/3,iter+1);
    BlockDiagMatCells{1,2}  =   makeBlockDiagMatCells(Nx,  Ny,  decFac/3,iter+1);
    BlockDiagMatCells{1,3}  =   makeBlockDiagMatCells(Nx,  Ny,  decFac/3,iter+1);
    
    BlockDiagMatCells{2,1}  =   makeBlockDiagMatCells(Nx,  Ny,  decFac/3,iter+1);
    BlockDiagMatCells{2,2}  =   makeBlockDiagMatCells(Nx,  Ny,  decFac/3,iter+1);
    BlockDiagMatCells{2,3}  =   makeBlockDiagMatCells(Nx,  Ny,  decFac/3,iter+1);
    
    BlockDiagMatCells{3,1}  =   makeBlockDiagMatCells(Nx,  Ny,  decFac/3,iter+1);
    BlockDiagMatCells{3,2}  =   makeBlockDiagMatCells(Nx,  Ny,  decFac/3,iter+1);
    BlockDiagMatCells{3,3}  =   makeBlockDiagMatCells(Nx,  Ny,  decFac/3,iter+1);
