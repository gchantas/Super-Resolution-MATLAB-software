function diagonalInverse=invertBlockMatrix(A,decFac)
...
if decFac==1
   ...
   % diagonalInverse=gpuArray(conj(A)./(abs(A).^2));
    ...
    temp2=invertBlockMatrix(  subtractBlockDiagMat( multiplyBlockDiagMat(multiplyBlockDiagMat( A12, A22inv, decFac ), A21, decFac ), A11,decFac ) ,    decFac);
