function [PSNR, ISNR, SSIMres]=SRviaDenoisingYCbCrPNLM_12_2_2020(pathHR,pathSR,pathLR,decFactor)
%clear all;
%myinput1=1;
%imNumber=13;
%randn('seed',0);
...
%Gaussian Blurring Function
        ...
        for exper=1:expNum
            ...
            c2{exper} = (2*patchX*patchY+max(patchX-abs(lenX),0)*max(patchY-abs(lenY),0) )  /   (2*patchX*patchY);

            c2{exper} = c2{exper}*1000;
